...
<html lang="en">
  <head>
    ...
    footer{
      ...
      body{             
         background-image:url('IMG/addbook1.jpg');
      ...
      body{             
         background-image:url('IMG/readAuthor.jpg');
         background-position: center;
         background-repeat: no-repeat;
         background-attachment: fixed;
         background-size:cover;
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light">
      ...
      <table class="mt-3 table table-success table-bordered table-striped">
        <thead>
        ...
        <?php
          foreach($authors as $authors_detail){
            ...
            echo "<td><a href='deleteAuthor.php?a_id=$a_id'class='btn btn-outline-danger'>Delete</a></td>";
            echo "<td><a href='updateAuthor.php?a_id=$a_id'class='btn btn-outline-warning'>Update</a></td>";
            echo "</tr>";
          }
