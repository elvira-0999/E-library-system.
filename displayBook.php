...
<html lang="en">
  <head>
    ...
    footer{
      ...
      body{             
         background-image:url('IMG/disBook.jpg');
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light">
      ...
      <table class="mt-3 table table-secondary table-bordered table-striped">
        <thead>
          <th>AUTHOR ID</th>
          <th>BOOK NAME</th>
          <th>BOOK GENRE</th>
        ...
        <tbody>
          <?php
            foreach($books as $book){
              ...
              echo "<tr>";
              echo "<td>".$book['author_id'];
              echo "<td>".$book['book_name'];
              echo "<td>".$book['book_genre'];
              echo "<td><a href='deleteBook.php?b_id=$book_id'class='btn btn-outline-danger'>DELETE BOOK</a></td>";
            echo "<td><a href='updateBook.php?b_id=$book_id'class='btn btn-outline-warning'>UPDATE BOOK</a></td>";
            echo "</tr>";
