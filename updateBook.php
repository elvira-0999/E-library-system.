  ...
  <head>
    ...
    <style>
     footer{
      ...
      body{             
         background-image:url('IMG/updateBook.jpg');
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-sm navbar-light bg-light">
        ...
        <div class="jumbotron mt-3 bg-warning">
          <div class="alert alert-warning text-center">UPDATE BOOK</div>
            <form action="library_action.php?b_id=<?php echo $b_id ?>" method="post">
              <div class="row mt-3">
                <div class="col-4">
              ...
              <div class="row mt-3">
                <div class="col-12">
                  <button type="submit" name="update_book" class="btn btn-danger">UPDATE BOOK</button>
                </div>
              </div>  
