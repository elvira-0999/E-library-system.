  ...
  <head>
    ...
    footer{
      ...
      .footer-distributed .footer-icons a{
       ...
       body{             
         background-image:url('IMG/addAuthor.jpg');
  ...
  <body >
   <div class="container"> 
      ...
      <div class="jumbotron mt-3 bg-light">
        <div class="alert alert-warning text-center">ADD AUTHOR</div>
        <form action="library_action.php" method="post">
          ...
          <div class="row mt-3">
            <div class="col-12">
              <button type="submit" name="add_author" class="btn btn-warning">ADD AUTHOR</button>
            </div>
          </div>
        </form>
      </div>
