...
<html lang="en">
  <head>
    ...
    <style>
     footer{
      ...
      body{             
         background-image:url('IMG/updateAuthor.jpg');
  ...
  <nav class="navbar navbar-expand-sm navbar-light bg-light">
      ...
      <div class="jumbotron mt-3">
        <div class="alert alert-danger text-center">UPDATE AUTHOR</div>
        <form action="library_action.php?a_id=<?php echo $a_id ?>" method="post">
          ...
          <div class="row mt-3">
            <div class="col-12">
              <button type="submit" name="update_author" class="btn btn-danger">UPDATE AUTHOR</button>
            </div>
          </div>
        </form>
      </div>
