...
<html lang="en">
  <head>
    ...
    <style>
     footer{
      ...
      body{             
         background-image:url('IMG/disReserve.jpg');
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light">
      ...
      <table class="mt-3 table table-warning table-bordered table-striped">
        <thead>
        ...
        <tbody>
          <?php
            foreach($reservation_list as $reserve){
              ...
              echo "<td><a href='delete_reservation.php?r_id=$reserve_id'class='btn btn-outline-danger'>Delete</a></td>";
              echo "<td><a href='update_reservation.php?r_id=$reserve_id' class='btn btn-outline-warning'>Update</a></td>";
              echo "</tr>";
            }
